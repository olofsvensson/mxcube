...
from MotorMockup import MotorMockup
import logging

class MotorWPositionsMockup(MotorMockup):
    
    def __init__(self, name, **kwargs):
        MotorMockup.__init__(self, name)
    
    def init(self):
        MotorMockup.init(self)
...
#       MotorMockup.motorMoveDone.im_func(self, channelValue)
